package com.viwcy.viwcysearch.config;

import com.viwcy.viwcysearch.service.RocketMQConsumeListenerProcessor;
...
public class RocketMQConsumerConfiguration {
    ...
    public DefaultMQPushConsumer getRocketMQConsumer() {
        ...
        try {
            ...
            e.printStackTrace();
            log.error("RocketMQ-consumer Initialize Fail，原因 = [{}]", e.getCause());
        }
        return consumer;
    }
